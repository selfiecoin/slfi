...
// Copyright (c) 2014 The SelfieCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("selfiecoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("selfiecoin-smsg-pow"); // Make this thread recognisable
