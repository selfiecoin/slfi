...
unsigned int nTargetSpacing     = 60;               // 69 seconds
...
const string strMessageMagic = "SelfieCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SelfieCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Take a selfie!";
        CTransaction txNew;
        txNew.nTime = 1416941617;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1416941617;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 403322 : 31234;
        ...
        assert(block.hashMerkleRoot == uint256("0x221241d937f41ad2139f6667ce05005e3090319c2c182e8aef8acc0605ce2a50"));
        block.print();
